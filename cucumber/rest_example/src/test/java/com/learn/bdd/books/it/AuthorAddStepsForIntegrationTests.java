...
import com.learn.bdd.books.facade.integration.AuthorsSystem;
import com.learn.bdd.books.framework.SpringBootBase;
...
@Ignore
public class AuthorAddStepsForIntegrationTests extends SpringBootBase {
    private AuthorsSystem  authorsSystem;
    private Author author;

    @Given("authors system is started")
    public void authorsSystemIsStarted() {
        System.out.println("Integration tests System is started.");
        authorsSystem = AuthorsSystem.create(mockMvc);
    }
